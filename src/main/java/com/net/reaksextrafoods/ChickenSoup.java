...
public class ChickenSoup extends Item {
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        tooltip.add(Text.translatable("chicken_soup_synopsis_p1").formatted(Formatting.RED));
        tooltip.add(Text.translatable("chicken_soup_synopsis_p2").formatted(Formatting.GREEN));
    }
}
