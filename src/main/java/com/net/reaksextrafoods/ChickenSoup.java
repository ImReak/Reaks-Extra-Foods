...
public class ChickenSoup extends Item {
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        tooltip.add(new TranslatableText("chicken_soup_synopsis_p1").formatted(Formatting.RED));
        tooltip.add(new TranslatableText("chicken_soup_synopsis_p2").formatted(Formatting.GREEN));
    }
}
