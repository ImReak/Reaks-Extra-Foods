...
public class Vodka extends Item {
    public Vodka(Settings settings){
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        tooltip.add(new TranslatableText("vodka_synopsis_p1").formatted(Formatting.RED));
        tooltip.add(new TranslatableText("vodka_synopsis_p2").formatted(Formatting.GREEN));
    }
}
